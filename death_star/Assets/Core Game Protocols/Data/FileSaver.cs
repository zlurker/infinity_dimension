...
public class FileSaver {
    public static FileSaveTemplate[] sFT = new FileSaveTemplate[] {
        new FileSaveTemplate<string>("Datafile", new string[]{ "Datafiles" },new string[]{"Ability.json","Info.json","WindowLocation.json","AbilityLauncher.json","NodeEndData.json"},(fP, t)=>{
