...
public class AbilityCentralThreadPool : NetworkObject, IRPGeneric, ITimerCallback {
    ...
    public void SetCentralData(int tId, Variable[][] rP, Type[] sT, int[] nBD, bool[][] aBD, int[][] amVar, int cId, Dictionary<int, Dictionary<Type, Dictionary<int, HashSet<int>>>> oVC) {
